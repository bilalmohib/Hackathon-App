...
class RegisteredStudent extends React.PureComponent {
    ...
    render() {
        console.log("The Student data is : ", this.state.user_data);
        return (
            <Container>
                        ...
                        renderItem={({ item, index }) => {
                            return (
                                <View>
                                    ...
                                    <TouchableOpacity onPress={() => this.props.navigation.navigate('StudentDetailsPage', {
                                       studentName:item.studentName,
                                       intro:item.intro,
                                       school:item.school,
                                       college:item.college,
                                       university:item.university,
                                       matricMarks:item.matricMarks,
                                       fscMarks:item.fscMarks,
                                       universityMarks:item.universityMarks,
...
// })
//updating the data of the state
export default connect(mapStateToProps, null)(RegisteredStudent);