            ...
            <CardItem>
              <Grid>
                <Row>
                  <Col>
                     <CardItem>
                       <Text style={styles.messageText}>Muhammad Bilal How would you like to register yourself.Click one choice below</Text>
                     </CardItem>
                  </Col>
                </Row>
              </Grid>
                      ...
                      <Body>
                        <Body>
                          <Icon.Button
                            ...
                            backgroundColor="red"
                            onPress={() =>
                              this.props.navigation.navigate('companyRegistration')
                            }
                          >
                        ...
                        <Body>
                          <Icon.Button
                            ...
                            onPress={() => {
                              ...
                              this.props.navigation.navigate('studentRegistration');
                            }}
                          >
