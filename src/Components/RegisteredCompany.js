...
class RegisteredCompany extends React.PureComponent {
            ...
            renderItem={({ item, index }) => {
              return (
                <View>
                  ...
                  <TouchableOpacity onPress={() => this.props.navigation.navigate('CompanyDetailsPage', {
...
// })
//updating the data of the state
export default connect(mapStateToProps, null)(RegisteredCompany);